...
const dailyInvoice = defineJob({ id: "daily-invoice", schema: v.object({ orgId: v.optional(v.string()) }) });
const sendEmail = defineJob({ id: "send-email", schema: v.object({ to: v.string(), template: v.string() }) });
