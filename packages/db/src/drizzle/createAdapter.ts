  ...
  const adapter: DrizzleAdapter = {
    ...
    defineTable(table, contract, mapping, defineOptions) {
      ...
      return {
        ...
        findById: (id: string) => sql.findById(id).execute(),
        ...
        delete: (id: string) => sql.delete(id).execute(),
        hardDelete: (id: string) => sql.hardDelete(id).execute(),
      } as DrizzleMappedTable<typeof table, typeof contract>;
    },
