...
## [0.2.2](https://github.com/elydelva/justwant/compare/job-v0.2.1...job-v0.2.2) (2026-03-28)
...
## [0.2.1](https://github.com/elydelva/justwant/compare/job-v0.2.0...job-v0.2.1) (2026-03-28)
...
## [0.2.0](https://github.com/elydelva/justwant/compare/job-v0.1.2...job-v0.2.0) (2026-03-28)
...
- Rename package from @justwant/cron to @justwant/job. API: createJob, JobService, JobDefinition, etc.

## 0.1.1

### Patch Changes

- Fix build and lint: add ioredis/@types/pg for E2E, node:module imports, optional chaining, const usage
